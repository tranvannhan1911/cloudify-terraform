...
resource "openstack_compute_instance_v2" "Server_20240813T004117849Z" {
  name              = "Server_20240813T004117849Z"
  count             = 1
  image_id          = ""
  key_name          = ""
  availability_zone = ""
...
resource "openstack_lb_loadbalancer_v2" "Load_Balancer_20240813T004201854Z" {
  name        = "Load_Balancer_20240813T004201854Z"
  description = ""
}
